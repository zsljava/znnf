			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfCommissioner/add.do"
						method="post">
  						...
  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="commissioner_number"
									name="commissioner_number"
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="commissioner_password"
									name="commissioner_password"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="commissioner_id_number"
									name="commissioner_id_number"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="commissioner_phone"
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="commissioner_workplace"
									name="commissioner_workplace"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						    						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="commissioner_status"
									name="commissioner_status"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="commissioner_remark"
									name="commissioner_remark"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="commissioner_create_name"
									name="commissioner_create_name"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						    						<div class="form-group">
