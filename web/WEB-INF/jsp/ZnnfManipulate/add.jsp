			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfManipulate/add.do"
						method="post">
  						...
  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="manipulate_name"
									name="manipulate_name"
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="manipulate_desc"
									name="manipulate_desc"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
