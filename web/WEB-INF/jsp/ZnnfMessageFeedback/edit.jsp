			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfMessageFeedback/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${znnfMessageFeedback.id}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="commissioner_number"
											name="commissioner_number" value="${znnfMessageFeedback.commissioner_number}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> send_id </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="send_id"
											name="send_id" value="${znnfMessageFeedback.send_id}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<input type="button" class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/znnfMessageFeedback/list.do'" value="返回" />
							</div>
						</div>
					</form>
