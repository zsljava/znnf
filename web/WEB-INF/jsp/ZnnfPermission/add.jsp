			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfPermission/add.do"
						method="post">
  						...
  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="permission_submenu"
									name="permission_submenu"
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="permission_filepath"
									name="permission_filepath"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
