			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfPermission/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${znnfPermission.id}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> permission_submenu </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="permission_submenu"
											name="permission_submenu" value="${znnfPermission.permission_submenu}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> permission_filepath </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="permission_filepath"
											name="permission_filepath" value="${znnfPermission.permission_filepath}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> manager_id </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="manager_id"
											name="manager_id" value="${znnfPermission.manager_id}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<input type="button" class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/znnfPermission/list.do'" value="返回" />
							</div>
						</div>
					</form>
