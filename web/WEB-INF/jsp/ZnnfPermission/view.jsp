					...
					<form class="form-horizontal">
						<!-- #section:elements.form -->
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${znnfPermission.permission_submenu}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${znnfPermission.permission_filepath}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${znnfPermission.manager_id}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<input type="button" class="btn btn-info" onclick="location.href='<%=request.getContextPath()%>/znnfPermission/list.do'" value="返回" />
							</div>
						</div>
					</form>
