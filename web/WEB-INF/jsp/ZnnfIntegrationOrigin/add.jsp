			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfIntegrationOrigin/add.do"
						method="post">
						<!-- #section:elements.form -->
  						...
  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="origin_create_name"
									name="origin_create_name"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
