			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfIntegrationOrigin/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${znnfIntegrationOrigin.id}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> origin_mode </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="origin_mode"
											name="origin_mode" value="${znnfIntegrationOrigin.origin_mode}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> origin_type </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="origin_type"
											name="origin_type" value="${znnfIntegrationOrigin.origin_type}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> origin_consume </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="origin_consume"
											name="origin_consume" value="${znnfIntegrationOrigin.origin_consume}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> origin_remark </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="origin_remark"
											name="origin_remark" value="${znnfIntegrationOrigin.origin_remark}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> origin_create_name </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="origin_create_name"
											name="origin_create_name" value="${znnfIntegrationOrigin.origin_create_name}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<input type="button" class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/znnfIntegrationOrigin/list.do'" value="返回" />
							</div>
						</div>
					</form>
