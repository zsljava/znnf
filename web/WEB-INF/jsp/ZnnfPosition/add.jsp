			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfPosition/add.do"
						method="post">
						<!-- #section:elements.form -->
  						...
  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="positoin_remark"
									name="positoin_remark"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="position_create_name"
									name="position_create_name"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
