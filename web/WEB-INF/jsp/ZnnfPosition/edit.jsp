			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfPosition/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${znnfPosition.id}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> position_name </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="position_name"
											name="position_name" value="${znnfPosition.position_name}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> position_level </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="position_level"
											name="position_level" value="${znnfPosition.position_level}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> position_desc </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="position_desc"
											name="position_desc" value="${znnfPosition.position_desc}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> position_status </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="position_status"
											name="position_status" value="${znnfPosition.position_status}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> position_type </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="position_type"
											name="position_type" value="${znnfPosition.position_type}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> positoin_remark </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="positoin_remark"
											name="positoin_remark" value="${znnfPosition.positoin_remark}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> position_create_name </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="position_create_name"
											name="position_create_name" value="${znnfPosition.position_create_name}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<input type="button" class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/znnfPosition/list.do'" value="返回" />
							</div>
						</div>
					</form>
