			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfMember/add.do"
						method="post">
						<!-- #section:elements.form -->
  						...
  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_id_photo"
									name="member_id_photo"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_landline_number"
									name="member_landline_number"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_recommended"
									name="member_recommended"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_bank_card_number"
									name="member_bank_card_number"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="menber_crop_name"
									name="menber_crop_name"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_cultivate_position"
									name="member_cultivate_position"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_soil_fertility"
									name="member_soil_fertility"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_crop_historical_production"
									name="member_crop_historical_production"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_fertilizer_costs"
									name="member_fertilizer_costs"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_comprehensive_cost"
									name="member_comprehensive_cost"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="member_update_name"
									name="member_update_name"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						    						<div class="form-group">
