			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfMemberWelfare/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${znnfMemberWelfare.id}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> welfare_rank </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="welfare_rank"
											name="welfare_rank" value="${znnfMemberWelfare.welfare_rank}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> welfare_integral_lowerlimit </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="welfare_integral_lowerlimit"
											name="welfare_integral_lowerlimit" value="${znnfMemberWelfare.welfare_integral_lowerlimit}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> welfare_integral_upperlimit </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="welfare_integral_upperlimit"
											name="welfare_integral_upperlimit" value="${znnfMemberWelfare.welfare_integral_upperlimit}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> welfare_discount </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="welfare_discount"
											name="welfare_discount" value="${znnfMemberWelfare.welfare_discount}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> welfare_remark </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="welfare_remark"
											name="welfare_remark" value="${znnfMemberWelfare.welfare_remark}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> welfare_create_name </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="welfare_create_name"
											name="welfare_create_name" value="${znnfMemberWelfare.welfare_create_name}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<input type="button" class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/znnfMemberWelfare/list.do'" value="返回" />
							</div>
						</div>
					</form>
