			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfMemberWelfare/add.do"
						method="post">
						<!-- #section:elements.form -->
  						...
  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="welfare_integral_lowerlimit"
									name="welfare_integral_lowerlimit"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="welfare_integral_upperlimit"
									name="welfare_integral_upperlimit"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="welfare_discount"
									name="welfare_discount"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
						  						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1"
									placeholder="welfare_create_name"
									name="welfare_create_name"
									class="col-xs-10 col-sm-5" />
							</div>
						</div>
