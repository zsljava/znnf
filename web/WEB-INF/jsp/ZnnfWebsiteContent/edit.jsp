			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfWebsiteContent/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${znnfWebsiteContent.id}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> content_introduce </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="content_introduce"
											name="content_introduce" value="${znnfWebsiteContent.content_introduce}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> content_image </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="content_image"
											name="content_image" value="${znnfWebsiteContent.content_image}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> connt_operator </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="connt_operator"
											name="connt_operator" value="${znnfWebsiteContent.connt_operator}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> content_remark </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="content_remark"
											name="content_remark" value="${znnfWebsiteContent.content_remark}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> title_id </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="title_id"
											name="title_id" value="${znnfWebsiteContent.title_id}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<input type="button" class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/znnfWebsiteContent/list.do'" value="返回" />
							</div>
						</div>
					</form>
