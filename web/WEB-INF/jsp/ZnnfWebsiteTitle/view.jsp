					...
					<form class="form-horizontal">
						<!-- #section:elements.form -->
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${znnfWebsiteTitle.title_content}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> title_operate_time </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${znnfWebsiteTitle.title_operate_time}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${znnfWebsiteTitle.title_operator}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${znnfWebsiteTitle.title_category}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${znnfWebsiteTitle.title_remark}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<input type="button" class="btn btn-info" onclick="location.href='<%=request.getContextPath()%>/znnfWebsiteTitle/list.do'" value="返回" />
							</div>
						</div>
					</form>
