			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/znnfWebsiteTitle/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${znnfWebsiteTitle.id}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> title_content </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="title_content"
											name="title_content" value="${znnfWebsiteTitle.title_content}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> title_operator </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="title_operator"
											name="title_operator" value="${znnfWebsiteTitle.title_operator}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> title_category </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="title_category"
											name="title_category" value="${znnfWebsiteTitle.title_category}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> title_remark </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="title_remark"
											name="title_remark" value="${znnfWebsiteTitle.title_remark}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<input type="button" class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/znnfWebsiteTitle/list.do'" value="返回" />
							</div>
						</div>
					</form>
